        ...
        <>
            ...
            <ContentContainer className="items-center w-container">
                ...
                <div className="w-full overflow-hidden">
                    <img className="w-full h-full object-contain" src="https://s3.amazonaws.com/caldwell.org/images/post/art/art-and-illustration/large-doodle-1400x1070-s0.7-q90.jpg" alt="large doodle" loading="lazy" />
                </div>
            </ContentContainer>
        </>
    );
